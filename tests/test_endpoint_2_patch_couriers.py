...
def test_not_found_request_nonexistent_courier():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "car",
                "regions": [33],
...
def test_good_request_create_courier():
...
def test_ok_request_existent_courier():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "car",
                "regions": [33],
...
def test_bad_request_existent_courier_wrong_value():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "train",
                "regions": [33],
...
def test_bad_request_existent_courier_wrong_value2():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "car",
                "regions": [33, "Moscow"],
...
def test_bad_request_existent_courier_wrong_value3():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "car",
                "regions": [33],
                "working_hours": ["09:70-39:00"]
        }
    )
    assert response.status_code == 400


def test_bad_request_existent_courier_extra_field():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "train",
                "regions": [33],
...
def test_ok_request_existent_courier_empty_arrays():
    response = client.patch("/couriers/1",
        json={
                "courier_type": "car",
                "regions": [],
